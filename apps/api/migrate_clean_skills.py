...
def categorize_clean_skills(flat_skills: list[str]) -> list[dict]:
    ...
    CATEGORIES = [
        ...
        ("AI/ML", [
            ...
            "gpu hardware acceleration", "gpu-based training", "nvlm", "triton",
            "inference optimization", "model optimization", "high-performance inference",
            "knowledge graph", "copilot", "domain-specific ai", "ai platform",
            ...
            "large language model", "large language models", "llm development",
            "rag-based systems", "end-to-end ai", "on-premise deployment",
            "nvidia ai stack", "document intelligence", "pii",
            "computer science", "neural networks",
            "sarsa", "thompson sampling", "q-learning", "cloud-native patterns",
        ]),
        ("Cloud Platforms", [
            ...
            "adls", "adls gen2", "azure data lake",
        ]),
